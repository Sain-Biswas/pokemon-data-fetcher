...
const BerryZodSchema = z.object({
	firmness: NamedAPIResourceZodSchema.describe("The firmness of this berry, used in making Pokéblocks or Poffins."),
	flavors: z
	...
	natural_gift_power: z.number().int().describe('The power of the move "Natural Gift" when used with this Berry.'),
	natural_gift_type: NamedAPIResourceZodSchema.describe(
		'The type inherited by "Natural Gift" when used with this Berry.'
	),
	size: z.number().int().describe("The size of this Berry, in millimeters."),
	smoothness: z.number().int().describe("The smoothness of this Berry, used in making Pokéblocks or Poffins."),
	soil_dryness: z
		.number()
		.int()
		.describe(
